...
Future<String> get content_readme async {
  Response response = await get(Uri.parse(
      "https://raw.githubusercontent.com/globalcorporation/.github/main/profile/readme.md"));
...
//
  ...
  int start_index_global_corporation = datas
      .indexWhere((element) => element == "<!-- START GLOBAL CORPORATION -->");
  if (start_index_global_corporation < 0) {
    print("Tolong tambahkan tags: <!-- START GLOBAL CORPORATION -->");
    exit(0);
  }
  int end_index_global_corporation = datas
      .indexWhere((element) => element == "<!-- END GLOBAL CORPORATION -->");
  ...
  datas.replaceRange(
      start_index_global_corporation, end_index_global_corporation + 1, lgoba);
